...
export default function OrderDetailPage() {
  ...
  <div className="p-4 max-w-7xl mx-auto">
      <Link href="/orders-list-management" className="inline-flex items-center gap-2 text-indigo-600 hover:text-indigo-800 text-xs font-medium mb-3">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-800">Order #{order._id.slice(-6).toUpperCase()}</h1>
            <p className="text-[11px] text-gray-500">{new Date(order.createdAt).toLocaleString()}</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <span className={`px-2.5 py-1 text-[11px] font-semibold rounded-full ${getStatusColor(order.orderStatus)}`}>
            {order.orderStatus}
          </span>
          <span className={`px-2.5 py-1 text-[11px] font-semibold rounded-full ${getPaymentColor(order.paymentStatus)}`}>
            {order.paymentStatus}
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
        <div className="lg:col-span-8 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className={cardClass}>
              <div className="flex items-center gap-1.5 mb-2">
                ...
                <h2 className="text-xs font-bold text-gray-800">Customer</h2>
              </div>
            ...
            <div className={cardClass}>
              <div className="flex items-center gap-1.5 mb-2">
                ...
                <h2 className="text-xs font-bold text-gray-800">Details</h2>
              </div>
          ...
          <div className={cardClass}>
            <div className="flex items-center gap-1.5 mb-2">
              ...
              <h2 className="text-xs font-bold text-gray-800">Items</h2>
            </div>
          ...
          <div className={cardClass}>
            <div className="flex items-center gap-1.5 mb-2">
              ...
              <h2 className="text-xs font-bold text-gray-800">Shipping Address</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4">
              ...
              <div className="flex items-start justify-between gap-4 py-1.5 border-b border-gray-50 last:border-0">
                ...
                <span className="text-[11px] font-semibold text-gray-800 text-right flex items-center gap-1">
        ...
        <div className="lg:col-span-4 bg-white rounded-xl border border-gray-200 shadow-md h-fit sticky top-4">
          <div className="p-3 border-b border-gray-100">
            <h2 className="text-sm font-bold text-gray-900">Update Order</h2>
            <p className="text-[10px] text-gray-500 font-medium mt-0.5">Compact status update</p>
          </div>
          ...
          <div className="p-4 space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-[#6f542f] hover:bg-[#5a4325] text-white py-2.5 rounded-xl font-bold text-xs transition-all shadow-md disabled:opacity-50 mt-1"
            >
